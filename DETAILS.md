...
The registry is a standard SQLite database located at:
- **Linux/macOS:** `~/.config/gitreg/gitreg.db`
- **Windows:** `%APPDATA%\gitreg\gitreg.db`

Developers are encouraged to query this database directly for custom reporting, dashboarding, or automation.
